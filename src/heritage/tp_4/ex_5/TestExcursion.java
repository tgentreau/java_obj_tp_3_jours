...
public class TestExcursion {
    public static void main(String[] args) {
        ...
        System.out.println("L'étape nommée "+testDuneEtapeSeule.getDescription()+" a une durée égale à "+ testDuneEtapeSeule.donneeDureePrevueHHMM().format(DateTimeFormatter.ofPattern("HH:mm")));
        ...
        System.out.println("La mini excursion nommée "+maMiniExc.getLibelleExcursion()+" a une duréeégale à "+ maMiniExc.donneDureePrevueHHMM().format(DateTimeFormatter.ofPattern("HH:mm")));
        MiniExcursionPayante maMiniExcPay=new MiniExcursionPayante("le parcours Java extraordinaire", 15,lesEtapes,1240);
        System.out.println("La mini excursion payante nommée "+maMiniExcPay.getLibelleExcursion()+" a une durée égale à "+maMiniExcPay.donneDureePrevueHHMM().format(DateTimeFormatter.ofPattern("HH:mm")) + " et coute: "+maMiniExcPay.getTarif()+" euros");
